                ...
                <div>
                    <div className="border-t-[3px] border-t-c_blue-dark pt-[12px]">
                        <div className="contactText">
                            {content.blocks[0]}
                            <a href={content.links.here} className="contactLink ml-[10px]" target="_blank">
                                {content.value[0]}
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="contactText">
                            ...
                            <div className="m:flex">
                                ...
                                <div className="s:flex">       
                                        <a href={content.links.signal} className="contactLink m:ml-[10px]" target="_blank">
                                            {content.value[3]}
                                        </a>   
                                </div>    
                            </div>
                    ...
                    <div className="border-t-[3px] border-t-c_blue-dark pt-[14px]">
                        <div className="contactText pb-0">
                            ...
                            <div className="m:flex">
                                <a href={content.links.habr} className="contactLink md:text-[48px] text-[26px]" target="_blank">
                                    {content.value[4]}
                                </a>,
