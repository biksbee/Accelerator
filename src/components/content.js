...
export const ourProjects = {
    ru: {
        ...
        subTitle: [
            'помогает получать доступ к заблокированному контенту, не раскрывая конфиденциальность даже провайдерам VPN.',
            'Решение для предоставления доступа к СМИ, заблокированным государственной цензурой в России. Сейчас бот использует 40% заблокированных СМИ.',
            'Open-source сервер-платформа на хостинге пользователя для развертывания персональных приватных сервисов (чатов, соцсети, почта, vpn и пр.)',
            'Децентрализованная электронная почта, т.е. работает без участия почтового сервера, поэтому ее практически невозможно взломать или заблокировать,',
            'Проект«Секьюрно» – персональный ассистент по комплексной безопасности человека.'
        ],
        slide: [
        'bg-slideAmnezia',
        'bg-slideGetSiteCopy',
        ...
        rightColumns: [
            [
                ...
                '+150К',
                'увеличили активную аудиторию проекта за 8 месяцев'
            ],
            [
                '40%',
