...
export const ourProjects = {
    ru: {
        ...
        subTitle: [
            'помогает получать доступ к заблокированному контенту, не раскрывая конфиденциальность даже провай....→',
            'Решение для предоставления доступа к СМИ, заблокированным государственной цензурой в России. Сейч....→',
