...
export const ourProjects = {
    ru: {
        ...
        //     'Open-source сервер-платформа на хостинге пользователя для развертывания персональных приватных се',
        //     'Децентрализованная электронная почта, т.е. работает без участия почтового сервера, поэтому ее пра',
        //     'Проект«Секьюрно» – персональный ассистент по комплексной безопасности человека. Проект«Секьюрно»'
        // ],
        slide: [
        'bg-slideAmnezia',
        'bg-slideGetSiteCopy',
