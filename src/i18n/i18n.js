    ...
    resources: {
        ru: { 
            translation: {
                ...
                ourProjects: {
                  ...
                  subTitle: {
                    0: 'помогает получать доступ к заблокированному контенту, не раскрывая конфиденциальность даже провайдерам VPN.',
                    1: 'Решение для предоставления доступа к СМИ, заблокированным государственной цензурой в России. Сейчас бот использует 40% заблокированных СМИ.',
                    2: 'Open-source сервер-платформа на хостинге пользователя для развертывания персональных приватных сервисов (чатов, соцсети, почта, vpn и пр.)',
                    3: 'Децентрализованная электронная почта, т.е. работает без участия почтового сервера, поэтому ее практически невозможно взломать или заблокировать,',
                    4: 'Проект«Секьюрно» – персональный ассистент по комплексной безопасности человека.'
                  },
                  slide: {
                    0: 'bg-slideAmnezia',
                  ...
                  rightColumns: {
                    0:{
                        ...
                        2:'+150К',
                        3:'увеличили активную аудиторию проекта за 8 месяцев'
                    },
                    1:{
                        0:'40%',
                ...
                deamhack: {
                  hackathon: 'Хакатон',
                  href: 'demhack.ru 🡽', 
                  text: 'Цель хакатона — поддержка духа сообщества, создание площадки для взаимодействия и сотрудничества специалистов из разных стран, возможность реализовать свои идеи для блага людей по всему миру и, защитить права на приватность и доступ к информации.* Мы собираем интересные идеи в формате заявок и задач на хакатон, а после хакатона поддерживаем команды, которые хотят продолжать работать над проектом. Основываясь на экспертных оценках и наблюдениях за работой команд на хакатоне, мы принимаем решение о продолжении работы с проектом в рамках акселератора.* Таким образом мы выстраиваем цепочку создания и развития проектов в области свободы интернета и приватности от момента инициации идеи до выхода проекта на рынок.* С 2020 года Privacy Accelerator и * Роскомсвобода* проводят хакатон Demhack дважды в год.',
                },
                moreAccelerator: {
                  mainTitle: "Больше, чем* просто акселератор",
                  title: 'Преакселератор, Акселератор, Инкубатор',
                  context: 'В преакселераторе мы помогаем командам провести исследование рынка и анализ конкурентов, изучить аудиторию. Вы сможете развить свою идею и определиться с продуктом, который будет полезен для аудитории и востребован на рынке. * В акселераторе мы обеспечиваем менторскую поддержку или сопровождение проектов в областях cusdev, маркетинг, ui/ux, управление проектами, право и т.д. Кроме того иногда мы привлекаем экспертов в области кибербезопасности, devops и разработки, но сама разработка всех остается на стороне команд. Программа акселератора рассчитана на 3 месяца.* Подойдет проектам на стадии масштабирования, а также командам, которые  не готовы к акселерации из-за временных ограничений. Вы сможете пользоваться нашим нетворкингом, прицельно проконсультироваться с экспертами и получить помощь в своем проекте по нашим сферам компетенций.',
                  requirements: "требования",
                  needed: 'Наличие идеи и первоначальной разработки. Команда готова тратить на проект как минимум 20 часов в неделю. * Наличие MVP и необходимой команды, готовых тратить на проект как минимум 20 часов в неделю. Для коммерческих проектов обязателен менеджер по продукту. * Проект в сфере приватности, свободы информации или legaltech. Есть оцифрованные результаты развития проекта.',
                  price: '0₽',
                  subtitle: 'Стоимость участия',
                  pretitle: 'Как для некоммерческих, так и для коммерческих проектов участие бесплатно.',
                },
                house: {
                  mainTitle: 'Вот, что* может дать* вашему проекту',
                ...
                team: {
                  ...
                  name: 'Станислав Шакиров, Наталья Малышева, Дарья Горбачева',
                  description: 'Основатель Privacy Accelerator, сооснователь Школы киберправа и Digital Rights Center, технический директор и сооснователь Роскомсвободы.* Руководитель по связям с общественностью РосКомСвободы, журналист и экоактивист. Эксперт в области СМИ, коммуникаций и продвижения, организации общественных кампаний. * Координатор Privacy Accelerator. Опыт в области коммьюнити-менеджмента, организации онлайн- и оффлайн-мероприятий.',
                  about: 'В 2020 году* команда Роскомсвободы запустила акселератор для поддержки инициатив в сферах приватности и анонимности, доступа к информации и свободы слова, электронного участия, развития ценностей цифрового гражданства, защиту прав и реализацию интересов граждан в цифровой среде. Политическая и интернет-цензура в Российской Федерации неуклонно усиливается с 2012 года, достигнув пика в 2022 году. В ответ мы видим все больший запрос в обществе на сервисы для защиты данных и свободы интернета. * Так например в 2022 году Россия переместилась с 15 места в мире по скачиванию VPN-сервисов на 2-е (с 2-3 млн до 12 млн. скачиваний). В Privacy Accelerator мы стремимся решить эти проблемы, запуская большее количество качественных проектов в сфере приватности и свободы интернета, а также повышая значимость проблем защиты данных, развивая интерес к теме среди разработчиков и предпринимателей. * История Рунета за 10 лет:',
        ...
        en: {
            translation: {
                ...
                moreAccelerator: {
                  mainTitle: "More than* just an accelerator",
                  title: 'Преакселератор, Акселератор, Инкубатор',
                  context: 'В преакселераторе мы помогаем командам провести исследование рынка и анализ конкурентов, изучить аудиторию. Вы сможете развить свою идею и определиться с продуктом, который будет полезен для аудитории и востребован на рынке. * В акселераторе мы обеспечиваем менторскую поддержку или сопровождение проектов в областях cusdev, маркетинг, ui/ux, управление проектами, право и т.д. Кроме того иногда мы привлекаем экспертов в области кибербезопасности, devops и разработки, но сама разработка всех остается на стороне команд. Программа акселератора рассчитана на 3 месяца.* Подойдет проектам на стадии масштабирования, а также командам, которые  не готовы к акселерации из-за временных ограничений. Вы сможете пользоваться нашим нетворкингом, прицельно проконсультироваться с экспертами и получить помощь в своем проекте по нашим сферам компетенций.',
                  requirements: "требования",
                  needed: 'Наличие идеи и первоначальной разработки. Команда готова тратить на проект как минимум 20 часов в неделю. * Наличие MVP и необходимой команды, готовых тратить на проект как минимум 20 часов в неделю. Для коммерческих проектов обязателен менеджер по продукту. * Проект в сфере приватности, свободы информации или legaltech. Есть оцифрованные результаты развития проекта.',
                ...
                house: {
                  mainTitle: 'That\'s what* can give * your project',
                ...
                team: {
                  ...
                  name: 'Stanislav Shakirov, Natalia Malysheva, Daria Gorbacheva',
                  description: 'Основатель Privacy Accelerator, сооснователь Школы киберправа и Digital Rights Center, технический директор и сооснователь Роскомсвободы.* Руководитель по связям с общественностью РосКомСвободы, журналист и экоактивист. Эксперт в области СМИ, коммуникаций и продвижения, организации общественных кампаний. * Координатор Privacy Accelerator. Опыт в области коммьюнити-менеджмента, организации онлайн- и оффлайн-мероприятий.',
                  about: 'In 2020 year* команда Роскомсвободы запустила акселератор для поддержки инициатив в сферах приватности и анонимности, доступа к информации и свободы слова, электронного участия, развития ценностей цифрового гражданства, защиту прав и реализацию интересов граждан в цифровой среде. Политическая и интернет-цензура в Российской Федерации неуклонно усиливается с 2012 года, достигнув пика в 2022 году. В ответ мы видим все больший запрос в обществе на сервисы для защиты данных и свободы интернета. * Так например в 2022 году Россия переместилась с 15 места в мире по скачиванию VPN-сервисов на 2-е (с 2-3 млн до 12 млн. скачиваний). В Privacy Accelerator мы стремимся решить эти проблемы, запуская большее количество качественных проектов в сфере приватности и свободы интернета, а также повышая значимость проблем защиты данных, развивая интерес к теме среди разработчиков и предпринимателей. * История Рунета за 10 лет:',
                  href: 'https://x.roskomsvoboda.org'
                },
                contact: {
                  mainTitle: 'Contacts',
